        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:robhamilton3rd@gmail.com.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/Rob1Ham/'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/Rob1Ham/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/Rob1Ham'), 
                ], 
                className='lead'
            )
        )
